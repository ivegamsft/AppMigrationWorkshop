    ...
    <form id="form1" runat="server">
   	...
   	<div class="container">
		<div class="col-md">
			...
			<%
                //SqlConnection MyConnection = new SqlConnection("Server=tcp:sql.contoso.com,1433;Database=dotnet;Persist Security Info=False;User ID=sqluser;Password=@Azure2018@Azure2018;MultipleActiveResultSets=False;Connection Timeout=30;");
		//SqlCommand MyCommand = new SqlCommand("SELECT TOP (10) [CustomerID],[FirstName],[MiddleName] FROM [SalesLT].[Customer]", MyConnection);
		SqlConnection MyConnection = new SqlConnection("Integrated Security=SSPI;Persist Security Info=False;Initial Catalog=dotnet;Data Source=sql.contoso.com");
		...
		SqlCommand MyCommand = new SqlCommand("select suser_name() as username", MyConnection);
                ...
                try
                {
                    ...
                    {
                        Response.Write("================================================</br>");
                        //Response.Write("Id: " + MyDataReader["Id"] + "</br>");
                        //Response.Write("Data: " + MyDataReader["Data"] + "</br>");
